                ...
                <Container>
                    ...
                    <Navbar.Collapse id="responsive-navbar-nav">
                        <Nav className="me-auto">
                            <Nav.Link as={Link} to="/" className="navbar-buttons">Features</Nav.Link>
                            <Nav.Link as={Link} to="/" className="navbar-buttons">Pricing</Nav.Link>
                        ...
                        <Nav>
                            <Nav.Link as={Link} to="/" className="navbar-buttons">More deets</Nav.Link>
